...
#define IS_SI block < BLOCK_POINTERS_IN_BLOCK + EXT2_NDIR_BLOCKS
#define IS_DI block < (BLOCK_POINTERS_IN_BLOCK * BLOCK_POINTERS_IN_BLOCK) + EXT2_NDIR_BLOCKS
#define IS_TI block < (BLOCK_POINTERS_IN_BLOCK * BLOCK_POINTERS_IN_BLOCK * BLOCK_POINTERS_IN_BLOCK) + EXT2_NDIR_BLOCKS
